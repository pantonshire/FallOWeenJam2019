...
class SpringInverted(world: World, position: Vec, val ySpeed: Float = 7.5f, val flip: Boolean = false): Entity(world, Vec(24f, 14f), position) {

    private val texturePath = "springInverted.png"
